...
ONIONINTEL_DB_PATH = _clean_env("ONIONINTEL_DB_PATH", "investigations/onionintel.sqlite3")
ONIONINTEL_API_URL = _clean_env("ONIONINTEL_API_URL", "http://localhost:8000")
